...
const ICONS = {
  ...
  copy: ['M10 8h9a3 3 0 0 1 3 3v9a3 3 0 0 1-3 3h-9a3 3 0 0 1-3-3v-9a3 3 0 0 1 3-3z', 'M5 16H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v1'],
}
...
<template>
  <svg
    v-if="FILL_ICONS[name]"
    :width="size" :height="size" viewBox="0 0 24 24"
    fill="currentColor" aria-hidden="true"
  >
    <path v-for="(d, i) in FILL_ICONS[name]" :key="i" :d="d" />
  </svg>
  <svg
    v-else
