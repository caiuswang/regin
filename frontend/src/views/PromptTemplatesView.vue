  ...
  <div v-else>
    <header class="page-header">
      ...
      <div class="page-header-actions">
        <button type="button" class="btn btn-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2" :disabled="editing === '__new__'" @click="startNew">
          New template
        </button>
      </div>
    </header>
    ...
    <Card v-if="editing" class="prompt-template-editor">
      ...
      <div class="mt-4 flex gap-2 justify-end">
        <button type="button" class="btn btn-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2" :disabled="busy === 'save'" @click="cancelEdit">Cancel</button>
        <button type="button" class="btn btn-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2" :disabled="busy === 'save'" @click="saveDraft">
        ...
        <tbody>
          <tr v-for="t in sortedTemplates" :key="t.slug">
            ...
            <td class="text-right">
              <button
                type="button"
                class="btn btn-secondary btn-xs mr-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                @click="startEdit(t)"
              >
                Edit
              </button>
              <button
                type="button"
                class="btn btn-secondary btn-xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2"
