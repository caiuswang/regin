...
<template>
  <Teleport to="body">
    <div
      v-if="dialog.visible"
      class="fixed inset-0 bg-black/40 hover:bg-black/40 z-50 flex items-center justify-center cursor-pointer"
      @click="onOverlay"
      @keydown="onKeydown"
    >
      <div class="bg-white rounded-lg shadow-xl max-w-sm w-full mx-4 overflow-hidden cursor-default">
