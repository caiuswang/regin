 ...
 * `data-component="src/views/MemoryView.vue"`.
 *
 * Gives `scripts/dom-measure.mjs --explain` (and the grab overlay) a direct
 * element→file mapping, so an agent reads the owning file instead of
 * grepping for a string it hopes is unique.
 *
